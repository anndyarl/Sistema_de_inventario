...
import { FileEarmark, FileEarmarkArrowUp, FileExcel } from "react-bootstrap-icons";
...
const BajasMensuales: React.FC<GeneralProps> = ({ isDarkMode }) => {
    ...
    const navigation: NavItem[] = [
        ...
        { descripcion: '', name: 'TrasladosMensuales', title: 'Traslados Mensuales', href: '/Informes/BajasMensuales/TrasladosMensuales', icon: FileEarmarkArrowUp },
        { descripcion: '', name: 'FoliosXServicioDependencia', title: 'Folios por Sercivio-Dependencia', href: '/Informes/BajasMensuales/FoliosXServicioDependencia', icon: FileEarmark },
        { descripcion: '', name: 'ExFolioXServicios', title: 'Excel-Folios por Servicios', href: '/Informes/BajasMensuales/ExFolioXServicios', icon: FileExcel },
    ];
