    ...
    return (
        ...
        <div className="container d-flex justify-content-center align-items-center vh-100 ">
            <div className="col-12 col-md-5 border p-4 rounded shadow-sm bg-white">
                ...
                <form id="Login" className="text-center mx-auto" onSubmit={onSubmit} style={{ maxWidth: '300px' }}>

                    <div className="form-group ">
                        <input type="text" className="form-control w-100 mx-auto m-1" id="inputusuario" name="usuario" value={usuario} placeholder="usuario" onChange={onChange} required />
                    </div>
                    <div className="form-group">
                        <input type="password" className="form-control w-100 mx-auto m-1" id="inputPassword" name="password" value={password} placeholder="Password" onChange={onChange} required />
                    </div>
                    ...
                    <button type="submit" className="btn btn-primary text-center m-1" >
                        {loading ? (<> {' Ingresar '}  <Spinner as="span" animation="border" size="sm" role="status" aria-hidden="true" /> </>) : ('Ingresar')}  </button>


                </form>
                {error ? (
                    <div className="alert alert-danger text-center p-2 m-2 fs-05em " role="alert">
                        Ocurrió un error al procesar la solicitud. Si el problema persiste, por favor pongase en contacto con la mesa de ayuda
                    </div>
                ) : <> </>}
