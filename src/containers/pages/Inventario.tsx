...
import { PlusCircle, BoxSeam, PencilSquare, Search, SlashCircle, Table } from "react-bootstrap-icons";
...
const Inventario: React.FC<FormInventarioProps> = ({
  ...
  const navigation: NavItem[] = [
    ...
    { descripcion: 'Registre los bienes asignados a funcionarios.', name: 'RegistroBienesFuncionarios', title: 'Bienes de Funcionarios', href: '/Inventario/RegistroBienesFuncionarios', icon: BoxSeam },
    { descripcion: 'Busque el activo de los Bienes de Funcionarios previamente registrados.', name: 'ListadoBienesFuncionarios', title: 'Listado Bienes de Funcionarios', href: '/Inventario/ListadoBienesFuncionarios', icon: Table },
