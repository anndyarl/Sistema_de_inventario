...
export const listaAltasActions = (fDesde: string, fHasta: string, estado: string, establ_corr: number, altasCorr: number) => async (dispatch: Dispatch, getState: any): Promise<boolean> => {
