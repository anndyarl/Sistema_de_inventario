...
// export const SET_FECHA_RECEPCION = "SET_FECHA_RECEPCION";
// export const SET_N_ORDEN_COMPRA = "SET_N_ORDEN_COMPRA";
// export const SET_HORA_RECEPCION = "SET_HORA_RECEPCION";
// export const SET_N_FACTURA = "SET_N_FACTURA";
// export const SET_ORIGEN_PRESUPUESTO = "SET_ORIGEN_PRESUPUESTO";
// export const SET_MONTO_RECEPCION = "SET_MONTO_RECEPCION";
// export const SET_FECHA_FACTURA = "SET_FECHA_FACTURA";
// export const SET_RUT_PROVEEDOR = "SET_RUT_PROVEEDOR";
// export const SET_NOMBRE_PROVEEDOR = "SET_NOMBRE_PROVEEDOR";
