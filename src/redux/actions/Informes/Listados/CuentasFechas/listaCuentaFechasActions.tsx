...
export const listaCuentaFechasActions = () => async (dispatch: Dispatch, getState: any): Promise<boolean> => {
  ...
  if (token) {
    ...
    try {
      const res = await axios.get(`${import.meta.env.VITE_CSRF_API_URL}/ReporteCuentaFechas`, config);
