...
export const comboTrasladoEspecieActions = () => async (dispatch: Dispatch, getState: any) => {
  ...
  if (token) {
    ...
    try {
      const res = await axios.get("https://sidra.ssmso.cl/api_erp_inv_qa/api/inventario/comboTraeTrasladoEspecie", config);
