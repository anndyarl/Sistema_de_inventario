...
import { DistribucionBien } from './BodegaExcluidos';
...
const DocumentoDistribucionPDF = ({ row }: { row: DistribucionBien[] }) => {
    ...
    return (
        <Document>
            <Page style={styles.page} wrap>
                ...
                <Text style={styles.tituloDocumento}>Bienes Seleccionados para Distribución</Text>
                {/* ===== lista a distribuir ===== */}
                ...
                <View style={styles.table} >
                    ...
                    <View style={styles.tableHeader} fixed>
                        <Text style={[styles.tableCell, styles.colRemate]}>Código</Text>
                        ...
                        <Text style={[styles.tableCell, styles.colFechaIngreso]}>Cuenta</Text>
                        <Text style={[styles.tableCell, styles.colObservaciones]}>Persona que entrega</Text>
                        <Text style={[styles.tableCell, styles.colCuenta]}>Oficina de destino</Text>
                    </View>
                    {row.map((lista, idx) => (
                        <View style={styles.tableRow} key={idx}>
                            <Text style={[styles.tableCell, styles.colRemate]}>{lista.bajaS_CORR}</Text>
                            ...
                            <Text style={[styles.tableCell, styles.colFechaIngreso]}>{lista.ncuenta}</Text>
                            <Text style={[styles.tableCell, styles.colObservaciones]}> {lista.persona_entrega}</Text>
                            <Text style={[styles.tableCell, styles.colCuenta]}>{lista.oficina_destino}</Text>
                        </View>
                    ))}
                </View>
...
export default DocumentoDistribucionPDF;
