...
import { List, FileRuled } from "react-bootstrap-icons";
    ...
    const navigation: NavItem[] = [
        {
            ...
            href: '/Informes/DetallesPorCuenta/ResumenCuentas',
            icon: FileRuled
        },
        {
            name: 'Detalle De Bienes',
            href: '/Informes/DetallesPorCuenta/DetalleDeBienes',
            icon: FileRuled
        },
        {
            name: 'Mensual',
            href: '/Informes/DetallesPorCuenta/Mensual',
            icon: FileRuled
        },
        {
            name: 'Anual',
            href: '/Informes/DetallesPorCuenta/Anual',
            icon: FileRuled
        },
    ];
